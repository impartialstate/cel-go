...
func (p *planner) Plan(expr ast.Expr) (InterpretableV2, error) {
	...
	if len(p.observers) != 0 {
		i = &ObservableInterpretable{InterpretableV2: i, observers: p.observers}
	}
	return i, nil
}
...
func (p *planBuilder) planCallAsync(expr ast.Expr, function string, overload string, impl *functions.Overload, args []InterpretableV2) (InterpretableV2, error) {
